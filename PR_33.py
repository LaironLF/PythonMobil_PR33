...
class MyApp(App):
    ...
    def build(self):
        ...
        self.Text_input = TextInput(text = "Здесь будут коды цветов")
    ...
    def Text_input_Code(self, instance):
    ...
    def update_Text_input(self):
        self.Text_input.text = self.Label_Code    
